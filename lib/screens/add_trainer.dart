...
class AddTrainer extends StatefulWidget {
  ...
  const AddTrainer({super.key, required this.gymName});
...
class _AddTrainerState extends State<AddTrainer> {
  ...
  Future<void> storeData() async {
    ...
    try {
      ...
      showMessage("Trainer not added | Something Went Wrong");
    }
  }
  ...
  Future<void> _checkUsers() async {
    try {
      ...
      QuerySnapshot querySnapshot = await trainersQuery.get();
